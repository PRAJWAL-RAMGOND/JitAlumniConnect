...
function editProfile() {
    ...
    document.querySelectorAll('.edit-role-fields').forEach(field => {
    ...
    if (currentUser.role === 'student') {
        ...
        if (alumniFields) {
            ...
            document.getElementById('editAlumniBranch').value = currentUser.branch || '';
            document.getElementById('editCompany').value = currentUser.company || '';
            document.getElementById('editAlumniDesignation').value = currentUser.designation || '';
        }
    } else if (currentUser.role === 'department') {
        const deptFields = document.getElementById('editDepartmentFields');
        if (deptFields) {
            deptFields.style.display = 'block';
            document.getElementById('editDeptName').value = currentUser.deptName || '';
            document.getElementById('editDeptDescription').value = currentUser.description || '';
        }
    }
...
function saveProfile(event) {
    ...
    if (currentUser.role === 'student') {
        updatedData.branch = document.getElementById('editBranch').value;
        updatedData.year = document.getElementById('editYear').value;
        updatedData.usn = document.getElementById('editUsn').value;
    } else if (currentUser.role === 'faculty') {
        updatedData.department = document.getElementById('editDepartment').value;
        updatedData.designation = document.getElementById('editDesignation').value;
        updatedData.experience = document.getElementById('editExperience').value;
    } else if (currentUser.role === 'alumni') {
        updatedData.batch = document.getElementById('editBatch').value;
        updatedData.branch = document.getElementById('editAlumniBranch').value;
        updatedData.company = document.getElementById('editCompany').value;
        updatedData.designation = document.getElementById('editAlumniDesignation').value;
    } else if (currentUser.role === 'department') {
        updatedData.deptName = document.getElementById('editDeptName').value;
        updatedData.description = document.getElementById('editDeptDescription').value;
    }
